width_last = 0.46;
width_first = 0.43;
width = linspace(width_first, width_last, 40);

for width_times = 1:numel(width)

    t_first = 395;
    t_last = 415;
    r0 = 8.8;
    k = width(width_times) / (2 * pi);
    v = 1;
    bench_numb = 224;
    ...
    for binary_times = 1:30
        ...
        % init_x1_y1 = [result_x(1), result_y(1)];
        ...
        % init_x2_y2 = [result_x(2), result_y(2)];
